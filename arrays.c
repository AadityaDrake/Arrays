...
/* Story 14
 * As a user, I want to be able to do a merge sort so I can compare
 * the speed of various types of sort.
 */
...
/* Story 15
 * As a user, I want to be able to do a quick sort so I can compare
 * the speed of various types of sort.
 */
